...
//    public ListNode partition_opt(ListNode head, int x) {
//        ListNode return_val = new ListNode(0);
//        ListNode help = head;
//        ListNode less_tail = null;
//        //ListNode less_head = null;
...
//                more_tail = help;
//            }
//            if(more_head!=null&&less_tail!=null)break;
//            help = help.next;
//        }
//        if (more_head==null||less_tail==null) return head;
//        if (head==more_head){
//            //从小往后把大的都接到more_tail后面，最后把morehead接到less_tail后面
//            more_tail.next = null;
//            prev = less_tail;
